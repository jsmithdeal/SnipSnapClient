...
export default function LoginForm(){
    ...
    return (
        <>
            ...
            <h2 className='text-white pt-5 md:pt-10'>No account? <Link to={PAGE_ROUTES.accesspages.createaccount} className='cursor-pointer text-amber-600 hover:text-indigo-600'>Sign up here.</Link></h2>
        </>
    )
}