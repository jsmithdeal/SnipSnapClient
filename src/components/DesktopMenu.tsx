    ...
    return (
        <div className={props.className} onClick={props.onClick}>
            <MenuItem icon={RiScissorsCutLine} iconWrapperClassName="inline-flex items-center pe-1" linkTo={PAGE_ROUTES.userpages.snips} linkText="Snips" 
                linkWrapperClassName="inline-flex" outterWrapperClassName="text-zinc-900 brand-font flex items-center text-xl duration-300 hover:-translate-y-1 hover:scale-105 pe-5" />
